...
<div class="card text-light shadow" data-bs-toggle="modal" data-bs-target="#recipeModal" @click="setActiveRecipe()">
  ...
  <div class="card-img-overlay">
    ...
    <p class="recipe-category fw-bold rounded-pill p-2">{{ recipeProp.category }}</p>
  </div>
</div>
